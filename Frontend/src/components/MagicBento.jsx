...
// ... (ParticleCard and GlobalSpotlight logic remains exactly the same as the source you provided)
// For brevity, assuming ParticleCard and GlobalSpotlight are pasted here from your prompt.
// I will just include the modified mapping function below.
...
const GlobalSpotlight = ({ gridRef, disableAnimations = false, enabled = true, spotlightRadius = DEFAULT_SPOTLIGHT_RADIUS, glowColor }) => {
...
// Modified to accept custom cards array
const MagicBento = ({
  cards = [],
  textAutoHide = true,
  enableStars = true,
  ...
  enableTilt = false,
  glowColor = '168, 85, 247', // Updated default to your purple hex #a855f7
  clickEffect = true,
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: '#161b22', // Match your dark background
          ...
          return (
            ...
            >
              {/* This renders your specific glowing number icon and text */}
              <div className="hiw-card-content">
                <div className="hiw-icon-wrapper">
                  <span className="hiw-number">{card.num}</span>
                </div>
